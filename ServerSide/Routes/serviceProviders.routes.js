...
router.patch("/:id", authMiddleware.verifyTokenAndAuthorization, serviceProviderControllers.updateProviderById);
router.delete("/:id", authMiddleware.verifyTokenAndAuthorization, serviceProviderControllers.deleteProviderById);
